...
### Added (live)
- Nexi Poland (PEP) — Poland (`PL`)
- Tatra Bank — Slovakia (`SK`)

## 2026-05-26

Initial snapshot: **389 live** + **4 coming-soon** PSP × country entries across **51 countries / regions**.
